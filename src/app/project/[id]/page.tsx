  ...
  return (
    <div className="flex flex-col gap-[150px]">
        ...
        <div className="flex flex-col gap-[50px] lg:justify-between lg:flex-1">
          ...
          <div className="flex flex-col lg:flex-row">
            {data?.summary.map((item) => (
              <div className="flex lg:flex-col px-2 lg:px-0 py-2 flex-1 justify-between lg:justify-center items-center border-b-2 lg:border-r-2 lg:border-b-0 lg:gap-2 dark:border-dark-dp12">
      ...
      <div className="flex flex-col items-center">
        <span className="text-[24px] font-bold text-light-primary dark:text-dark-primary">
          Skills
        </span>
        <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
          {data?.skills.map((skill) => <SkillLogo type={skill} />)}
        </div>
      </div>
      <div className="w-full flex flex-col items-center gap-[40px]">
        ...
        <div className="w-full flex flex-col gap-10">
          {data?.contents.map((content, index) => (
            <div
              className={`h-[400px] flex flex-col-reverse ${index % 2 !== 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-12`}
            >
      ...
      <div className="flex flex-col items-center">
        <span className="text-[24px] font-bold text-light-primary">
          Project Images
        </span>
        <div></div>
      </div>
